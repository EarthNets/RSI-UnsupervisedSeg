...
def train():
  ...
  #print(len(dataloaders_head_A),len(mapping_assignment_dataloader),len(mapping_test_dataloader))
  #print('Arrive here!!')
  ...
  if config.restart:
    ...
    config.epoch_avg_subhead_iou = config.epoch_avg_subhead_iou[:next_epoch]
    ...
    _ = segmentation_eval(config, net,
                          ...
                          using_IR=config.using_IR,verbose=1)
